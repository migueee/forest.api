...
class hum{
  ...
  public function getActual(){
    $sql="SELECT ld.dat_humedad, ld.est_id 
    ...
    $sql=$sql." and idm.id_mayor=ld.dat_id
          GROUP BY ld.est_id,ld.dat_humedad
          ORDER BY ld.est_id,ld.dat_humedad"; 
  ...
  public function get24h(){
    $sql="SELECT  ld.dat_humedad, (ld.hor_id/240) as hora,ld.est_id
